...
class TFDB.RocketFlags
{
	...
	CustomModel      = 1 << 10;
	CustomSpawnSound = 1 << 11;
	CustomBeepSound  = 1 << 12;
	CustomAlertSound = 1 << 13;
...
class TFDB.Rocket
{
	...
	function HandleCollision(hRocketEntity)
	{
		...
		if (!TraceLineEx(hTraceOutput) ||
		    !hTraceOutput.hit ||
		    ((strEntHit in hTraceOutput) && hTraceOutput.enthit.IsPlayer()))
		{
			return;
		}
...
class TFDB.RocketType
{
	...
	constructor(table)
	{
		...
		this.BeepInterval      = table.BeepInterval;
		this.SpawnSound        = table.SpawnSound;
		this.BeepSound         = table.BeepSound;
		this.AlertSound        = table.AlertSound;
		this.DelaySound        = table.DelaySound;
		this.CritChance        = table.CritChance;
		this.Damage            = table.Damage;
		this.DamageIncrement   = table.DamageIncrement;
		this.Speed             = table.Speed;
		this.SpeedIncrement    = table.SpeedIncrement;
		this.SpeedLimit        = table.SpeedLimit;
		this.Turnrate          = table.Turnrate;
		this.TurnrateIncrement = table.TurnrateIncrement;
		this.TurnrateLimit     = table.TurnrateLimit;
		this.ElevationRate     = table.ElevationRate;
		this.ElevationLimit    = table.ElevationLimit;
		this.RocketsModifier   = table.RocketsModifier;
		this.PlayerModifier    = table.PlayerModifier;
		this.ControlDelay      = table.ControlDelay;
		this.DragTimeMin       = table.DragTimeMin;
		this.DragTimeMax       = table.DragTimeMax;
		this.TargetWeight      = table.TargetWeight;
		this.CmdsOnSpawn       = table.CmdsOnSpawn;
		this.CmdsOnDeflect     = table.CmdsOnDeflect;
		this.CmdsOnKill        = table.CmdsOnKill;
		this.CmdsOnExplode     = table.CmdsOnExplode;
		this.CmdsOnNoTarget    = table.CmdsOnNoTarget;
		this.MaxBounces        = table.MaxBounces;
		this.BounceScale       = table.BounceScale;
	}
...
class TFDB.ChancesTable
{
	...
	constructor(table)
	{
		this.RocketTypeIndex = table.RocketTypeIndex;
		this.Chances         = table.Chances;
	}
}
...
class TFDB.SpawnerType
{
	...
	{
		this.Name          = table.Name;
		this.MaxRockets    = table.MaxRockets;
		this.Interval      = table.Interval;
		this.ChancesTables = table.ChancesTables;
	}
